...
<div class="h-[94vh] text-slate-400 overflow-auto scroll-m-8 no-scrollbar::-webkit-scrollbar w-full " id="scrollable">
    <br>
	<img
		{src}
	...
	<br />
	<p class=" relative indent-20 text-lg w-[50%] left-1/4">
